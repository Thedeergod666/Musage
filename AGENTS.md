...
> 任何新打开此项目的 AI 会话应先读这个文件。这是当前对话的精炼版（v0.2.4 + Unreleased StepFun 一键登录 + Kimi 总套餐 / 2026-08-04 快照）。
