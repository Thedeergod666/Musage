...
> Status: **v0.2.0 (2026-06-29) 已发布** — 11 内置 + CustomSource + 多实例 + 完整 i18n + 自动更新。P1/P2-A/P2-B 大部分完成,实际完成度逐项核对见下表。
...
- i18n 残留 <5%(`types.ts` 6 行 / `credentials.ts:307/387` / `updater.ts:90`)
...
## Tech debt (v0.2.0 全量审查刷新, 2026-06-29)
...
### High(留 v0.3)
- ⏳ 12 provider 错误分类不统一(401/403/429 各自映射不同),缺 `http_status_to_error_kind` helper — **留 v0.3**
